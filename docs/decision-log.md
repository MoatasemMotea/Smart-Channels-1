...
- **Tally:** 32 of 33 types photographed. On the placeholder: PTT Radios only. The computing-category smoke test now expects six photographed and none held. Gates: `npm run validate`, `npm run check` (11), `npm run build`, `npm run test:smoke` (149 passed, 25 skipped).
